...
function createNewData(e) {
  ...
  let alert = document.getElementById("alertPeserta");

  alert.className = "alert alert-danger";
  alert.style.marginTop = "10px";

  if (namaPeserta === "") {
    alert.innerText = "Data Nama Harus di Isi";
  } else if (umurPeserta === "") {
...
function dataBaru(e) {
  ...
  let alert = document.getElementById("alertPanitia");
  ...
  if (namaPanitia === "") {
    ...
    //     alert.innerText = "Data Umur Harus di Isi";
    //   }
    //   if (pilihanLomba === "0" || pilihanLomba.length == 0) {
    //     alert.innerText = "Data Umur Harus di Isi";
    //   }
